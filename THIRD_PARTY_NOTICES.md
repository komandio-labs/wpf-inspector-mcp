...
This tool incorporates and modifies source from
[snoopwpf/snoopwpf](https://github.com/snoopwpf/snoopwpf), specifically its
`Snoop.GenericInjector` and `Snoop.InjectorLauncher` implementation.
